...
@section('title', 'Browse Services - ' . ($settings->platform_name ?? 'Dooter Enterprises'))
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card border border-light h-100 p-3 rounded-3 bg-light d-flex flex-column shadow-sm-hover transition-all">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-auto">
                            <span class="text-muted small"><i class="bi bi-clock-history"></i> Direct Processing</span>
                            <a href="{{ route('client.book', $service->id) }}" class="btn btn-dark btn-sm rounded-pill px-3">Book Now</a>
                        </div>
                    </div>
                </div>
            @endforeach
