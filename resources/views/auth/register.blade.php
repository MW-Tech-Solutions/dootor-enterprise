...
@section('title', 'Join as Vendor - ' . ($settings->platform_name ?? 'DOOTOR ENTERPRISES'))
...
<div class="container-fluid p-0 min-vh-100 d-flex flex-column flex-lg-row">
    ...
    <div class="col-lg-5 d-none d-lg-flex flex-column justify-content-between p-5 text-white position-relative" style="background: linear-gradient(135deg, #001a0c 0%, #003b1c 100%); min-height: 100vh;">
        ...
        <div>
            <a href="/" class="d-inline-flex align-items-center gap-2 text-decoration-none text-white mb-5">
                ...
                @else
                    <svg width="40" height="40" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" class="me-1">
                        <!-- Stylized D (Gold) -->
                        <path d="M20 20C40 20 52 32 52 50C52 68 40 80 20 80C14 80 14 74 14 74V26C14 26 14 20 20 20Z" fill="url(#goldLogoRegVendor)" />
                        ...
                        <defs>
                            <linearGradient id="goldLogoRegVendor" x1="14" y1="20" x2="52" y2="80" gradientUnits="userSpaceOnUse">
            ...
            <h2 class="display-6 fw-bold text-white mb-3" style="line-height: 1.2;">Join Our Elite Agent Network</h2>
            <p class="text-white-50 mb-5 fs-6">Register as a service consultant. Help clients manage processing operations for passports, visas, BVN validation, and legal certifications.</p>
            ...
            <div class="d-flex flex-column gap-3">
                <div class="d-flex align-items-start gap-3">
                    ...
                    <div>
                        <h5 class="mb-0 text-white fw-semibold small">Grow Your Client Portfolio</h5>
                        <p class="text-white-50 small mb-0">Connect directly with diaspora clients requiring trusted hands-on documentation services.</p>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-start gap-3">
                    ...
                    <div>
                        <h5 class="mb-0 text-white fw-semibold small">Flexible Rate Customization</h5>
                        <p class="text-white-50 small mb-0">Define your own storefront services, processing pricing rates, and details dynamically.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Right Pane: Vendor Registration Form Container -->
    <div class="col-lg-7 d-flex align-items-center justify-content-center bg-light py-5 px-3 px-sm-5" style="flex-grow: 1; min-height: 100vh;">
        <div class="card border-0 shadow-sm p-4 p-sm-5 rounded-4 bg-white" style="max-width: 520px; width: 100%;">
                ...
                <a href="/" class="d-inline-flex align-items-center gap-2 text-decoration-none text-dark mb-2">
                    ...
                    @else
                        <svg width="28" height="28" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" class="me-1">
                            ...
                            <path d="M50 24H80V35H64V44H76V53H64V63H80V74H50V24Z" fill="#004225" />
                            <defs>
                                <linearGradient id="goldLogoRegVendorMobile" x1="14" y1="20" x2="52" y2="80" gradientUnits="userSpaceOnUse">
                                    <stop offset="0%" stop-color="#FFE57F" />
                                    <stop offset="50%" stop-color="#D4AF37" />
                                    <stop offset="100%" stop-color="#AA820A" />
                                </linearGradient>
            ...
            <div class="mb-4">
                <h1 class="h3 fw-bold text-dark mb-1">Become a Vendor</h1>
                <p class="text-secondary small">Sign up to offer services to clients worldwide</p>
            </div>
